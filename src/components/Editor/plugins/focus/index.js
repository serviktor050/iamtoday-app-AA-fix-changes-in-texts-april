  ...
  return {
    onChange: (editorState) => {
      ...
      if (lastSelection && selection.equals(lastSelection)) {
        // console.error('RD LS equals', editorState.getSelection());
      ...
      if (lastSelection) {
        ...
        if (lastBlockMapKeys.some((key) => focusableBlockKeys.includes(key))) {
          // console.error('RD LS lastSelection', selection);
      ...
      if (currentBlockMapKeys.some((key) => focusableBlockKeys.includes(key))) {
        // console.error('RD LS selection', selection);
        lastSelection = selection;
        // By forcing the selection the editor will trigger the blockRendererFn which is
        // necessary for the blockProps containing isFocus to be passed down again.
        return EditorState.forceSelection(editorState, editorState.getSelection());
      ...
      // console.info('lastSelection', lastSelection, lastSelection && selection.equals(lastSelection));
      // console.info('selection', selection.getStartKey(), selection.getEndKey());
      // console.info(
      //   'focusableBlockKeys',
      //   focusableBlockKeys,
      //   currentBlockMapKeys.map(key => key)
      // );
