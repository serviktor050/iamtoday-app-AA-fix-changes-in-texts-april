  ...
  render() {
    ...
    return (
      <div id="layout" className={styles.layout}>
        ...
        {/*!isEmpty && page !== 'chats' && isRegistered && !isSimpleRegs && !window.mobilecheck() && !window.mobileAndTabletcheck() &&
          <MiniChat params={params} taskDay={taskDay.data[0]}/>
      */}

        <div
          className={classNames(styles.layoutInner, {
            [styles.layoutInnerSmm]: smm || buy,
          })}
        >
        ...
        {/* {isRegistered && !isSimpleRegs && <ul className={styles.menuMobBottom}>
          <li
          ...
          >
            ...
            {menuList[3] && !menuList[3].disabled && (
              ...
              <span className={styles.menuMobBottomTitle}>{i18n['menu.chat']}</span>
            </Link>
          </li>
          <li
            className={menuList[5] && menuList[5].active
              ? styles.menuMobBottomItemActive
              : styles.menuMobBottomItem
            }
          >
            <Link to={'/smm'} className={styles.menuMobBottomItemInner}>
              ...
              <span className={styles.menuMobBottomTitle}>{i18n['menu.news']}</span>
            </Link>
          </li>
