...
class DatePicker extends Component {
  ...
  render() {
    ...
    const themeClassName = ['default', 'dark', 'ios', 'android', 'android-dark'].indexOf(theme) === -1
      ? 'default' : theme
        ...
        <div
            ...
            <div className="datepicker-navbar">
                <a
                    ...
                    onClick={this.handleFinishBtnClick}>Выбрать</a>
                <a
                    className="datepicker-navbar-btn"
                    onClick={this.props.onCancel}>Отмена</a>
            </div>
        </div>
    )
  }
