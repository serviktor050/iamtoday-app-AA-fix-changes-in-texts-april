...
import styles from './pendingInsuranceProfiles.css'
...
class UserReports extends Component {
  ...
  render() {
    ...
    const filterText = userFilterText => {
      ...
      fetchPendingInsuranceProfiles(DEFAULT_PAGE, undefined, this.refs.filterText.value)
    }
    ...
    const filterId = user => {
      ...
      fetchPendingInsuranceProfiles(DEFAULT_PAGE, this.refs.filterId.value, undefined)
    }
