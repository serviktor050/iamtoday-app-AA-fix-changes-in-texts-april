...
const CheckboxProfile = (props) => {
  ...
  const isCurrent = input.name.split('.')[2] === 'isCurrent' ? true : false
  return (
    <div className={classNames(styles.checkboxesItem, {
      ...
      <span className={styles.checkbox}>
        <label className={styles.checkboxLabel} htmlFor={id}>
          ...
          <span className={classNames(isCurrent || className === 'blue' ? styles.checkboxPhBlue : null, styles.checkboxPh, {
            [styles.sign]: kind ===  'sign'
          })}>
